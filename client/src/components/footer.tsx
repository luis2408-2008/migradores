        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <Compass className="h-6 w-6 text-primary-400 mr-2" />
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-neutral-400 hover:text-white transition-colors duration-200" aria-label="Youtube">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/ayuda" className="text-neutral-400 hover:text-white transition-colors duration-200">Contacto</Link>
              </li>
            </ul>
          </div>
        </div>
